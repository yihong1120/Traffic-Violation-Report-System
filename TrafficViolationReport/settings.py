...
if not GEMINI_API_KEY:
    raise ValueError("No 'GEMINI_API_KEY' set in the configuration.")
...
if not EMAIL_HOST_USER:
    raise ValueError("No 'EMAIL_HOST_USER' has been set in the environment.")

EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_HOST_PASSWORD')
if not EMAIL_HOST_PASSWORD:
    raise ValueError("No 'EMAIL_HOST_PASSWORD' has been set in the environment.")

DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL')
if not DEFAULT_FROM_EMAIL:
    raise ValueError("No 'DEFAULT_FROM_EMAIL' has been set in the environment.")
